//
//  SettingsDrawPadViewController.swift
//  Ionkepler
//
...
protocol SettingsDrawPadDelegate: class {
	func settingsDrawPadFinished(settingsDrawPad: SettingsDrawPadViewController)
}

class SettingsDrawPadViewController: UIViewController {
	...
	weak var delegate: SettingsDrawPadDelegate?
	...
	@IBAction func close(sender: AnyObject) {
		...
		self.delegate?.settingsDrawPadFinished(self)
	}
